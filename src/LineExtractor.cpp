...
//        cout<<"scale = "<<scale<<" numOctaves = "<<numOctaves<<endl;
//        getchar();
        ...
        _lineVec2d.clear();
        ///原来归一化的线函数是这么计算的  给二维线特征的端点加一维1 然后叉乘归一化   就变成了mvKeyLineFunctions
    ...
    void LINEextractor::computeDesc(cv::InputArray image, std::vector<line_descriptor::KeyLine> &keylines,
                                    cv::OutputArray descriptors, std::vector<Eigen::Vector3d> &lineVec2d) {
